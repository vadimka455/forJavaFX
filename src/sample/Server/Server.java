...
public class Server {
    ...
    public static  void main(String[] args)throws Exception{
        ...
        while(true) {
            ...
            System.out.println(datagramChannel.isConnected());
            byteBuffer.flip();
            ...
            System.out.println("Получил "+byteArrayToInt(forCommand));
            ...
            if (forCommand[0] == (byte) 1 || forCommand[0]==(byte)2) {
                System.out.println("Сложная команда");
                byteBuffer.clear();
                ...
                System.out.println("Получил "+byteArrayToInt(forObject));
            }
            byteBuffer.clear();
            switch (forCommand[0]){
                case (byte)1: {
...
//                    byteBuffer.put(length);
                        ...
                        System.out.println("HashCode has been genereted...");
                        System.out.println(new Date(System.currentTimeMillis()));
                        byteBuffer.put(intToByteArray(hashCode));
                        byteBuffer.flip();
                        datagramChannel.send(byteBuffer, rm);
                        byteBuffer.flip();
                        System.out.println("HashCode has been sended... " + byteArrayToInt(byteBuffer.array()));
                        byteBuffer.clear();
                        for (Potatoes potatoes : listOfPotatoes) {
                    ...
                    /*Iterator<Potatoes> iterator = newclubni.iterator();
                    Potatoes potatoes;
                    while (iterator.hasNext()){
                        ...
                        byteBuffer.flip();
                        datagramChannel.send(byteBuffer,remoteAddress);
                        System.out.println("SendBack "+byteArrayToInt(byteArrayOutputStream.toByteArray()));
                        byteBuffer.clear();
                    }*/
